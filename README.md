...
<p align="center">
  <a href="https://www.linkedin.com/in/harsh-negi-4846a8301/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
  &nbsp;
...
B.Tech Mechanical Engineering at **MNNIT Allahabad**. I build end-to-end ML systems, data pipelines, and agentic AI workflows — from real-time CCTV analytics to LLM-driven agents. Codeforces **Expert** with 1000+ problems solved across platforms.

|  |  |
|--|--|
| **Currently** | Building ML pipelines and agentic AI workflows for production |
| **Education** | MNNIT Allahabad · B.Tech Mechanical Engineering · CPI 7.54 |
| **Focus** | ML Systems · Data Engineering · Agentic AI · Full Stack |
| **Open To** | Data Analyst · Data Scientist · Data Engineer · SDE roles |
...
**Store Intelligence System** &nbsp;`Featured`

`YOLOv8` `ByteTrack` `FastAPI` `PostgreSQL` `React` `Docker`

End-to-end CCTV retail analytics built for **Purplle Engineering Hiring Challenge 2026**. Real-time person tracking, zone heatmaps, React dashboard — fully containerized. **82% Pytest coverage.**
...
Retention strategy certified by **IIT Guwahati C&A Club, Summer '26**. RFM scoring, churn prediction in SQL, interactive Power BI dashboard.
...
ML model achieving **R² ≈ 0.81** deployed on AWS SageMaker. Cross-version compatibility via XGBoost JSON format. Live Streamlit frontend.
...
Agentic AI with multi-step planning, tool-calling, RAG memory via ChromaDB, and sandboxed code execution. Powered by Groq free tier.
...
|:---:|:---:|:---:|
| Codeforces | [Harshnegi2005](https://codeforces.com/profile/Harshnegi2005) | **Expert · 1700+** |
| LeetCode | [HarshNegi](https://leetcode.com/HarshNegi) | **1700+ · 1000+ Solved** |

Graphs &nbsp;·&nbsp; Dynamic Programming &nbsp;·&nbsp; Number Theory &nbsp;·&nbsp; Combinatorics
